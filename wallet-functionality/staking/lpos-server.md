...
```bash
wget https://github.com/NixPlatform/NixCore/releases/download/v3.0.7/nix-3.0.7-x86_64-linux-gnu.tar.gz
```

Unpack the file.

```bash
tar -zxvf nix-3.0.7-x86_64-linux-gnu.tar.gz
```
